...
@Controller
public class ImgVerifyCode extends BaseController {
   ...
   */
	  ...
	  public void images(HttpServletRequest req, HttpServletResponse resp)  throws ServletException,IOException {
		    ...
		    session.setAttribute( com.hzdracom.manager.constant.ContextConstant.LOGIN_IMAGE_CODE , randomCode.toString());
