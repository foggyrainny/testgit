...
public class HttpUtil
{
	...
	public static String doPost(String url, String data) {
		...
		try
		{
			...
			osw.write(URLEncoder.encode(Util.NullToString(data),charset));
			osw.flush();
			osw.close();
			out.flush();
			out.close();
	...
	* @date 2014-1-2 下午1:09:42
		...
		try
		{
			...
			if (params != null)
			{
				for (Entry<String, String> e : params.entrySet())
				{
					sb.append(e.getKey());
					sb.append("=");
					sb.append(URLEncoder.encode(Util.NullToString(e.getValue()),charset));
					sb.append("&");
				}
	 ...
	 */
	public static String doPost(String url, ArrayList<Entry<String, String>> list) throws UnsupportedEncodingException {
		//读取返回内容
		StringBuffer buffer = new StringBuffer();
		HttpURLConnection con = null;
		//构建请求参数
	 ...
	 * @date 2013-12-13 上午10:35:32
	 */
	public static String doPost1(String url, Map<String, String> params) throws UnsupportedEncodingException {
		//读取返回内容
		StringBuffer buffer = new StringBuffer();
		HttpURLConnection con = null;
		//构建请求参数
