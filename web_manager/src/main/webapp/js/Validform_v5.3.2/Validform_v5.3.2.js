...
(function($,win,undef){
	...
	if(_LANG=="zh"){
		...
		var tipmsg={//默认提示文字;
				...
				w:{
					"*":"Can't be empty!",
					"*6-16":"Please fill in 6 to 16 bit any character!",
					...
					"m":"Please fill in the phone!",
					"e":"The mailbox address format is wrong!",
					"url":"Please fill in the URL!"
				},
				def:"Please fill in the correct info!",
				undef:"DataType undefined!",
				reck:"Two times the contents of the input inconsistent!",
				//r:"验证通过！",
				r:"",
				c:"Detecting information ...",
				s:"Please {fill in | select}{0| Info}!",
				v:"The information you filled out is not verified.",
				p:"Submitting data ..."
			}
