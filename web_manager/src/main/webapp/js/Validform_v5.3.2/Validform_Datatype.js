	...
	if($.Datatype){
		if(_LANG=="zh"){
			...
			$.extend($.Tipmsg.w,{
				...
				"zh":"Fill in Chinese!",
				"dword":"Fill in Double-byte characters!",
				"money":"Fill in the Currency value!",
				"ipv4":"Fill in the IP address!",
				"ipv6":"Fill in the IPV6 address!",
				"num":"Please fill in the value!",
				"qq":" fill in the QQ number!",
				"unequal":"Value cannot be equal!",
				"notvalued":"Cannot contain a specific value!",
				"idcard":"The I.D. number is wrong!",
				"double1-2":"keep 1 to 2 decimal places",
				"login":"fill in the number or letter, length 5-15 characters",
				"nlu":" fill in numeric characters or underscores!"
			});
		}
