...
<div class="panel panel-primary panel-heading">
  <fieldset>
    ...
    <div class="form-group">
      <input id="f_LIKE_S_realname" name="teacher.map.name"  value="${teacher.map.name}"  type="text" class="form-control" style="width:120px;">
    </div>   
    ...
    <div class="form-group">
      <input id="f_LIKE_S_realname" name="teacher.position"  value="${teacher.position}"  type="text" class="form-control" style="width:120px;">
    </div>
    ...
    <div class="form-group">
      <input id="f_LIKE_S_realname" name="teacher.map.start_age"  value="${teacher.map.start_age}"  type="text" class="form-control" style="width:120px;">至
      <input id="f_LIKE_S_realname" name="teacher.map.end_age"  value="${teacher.map.end_age}"  type="text" class="form-control" style="width:120px;">
    </div>   
...
<form method="post">
  <div class="panel panel-primary">
    <div class="panel-heading">
    	...
    	<button type="button" class="btn btn-success" onclick="location.href='inputTeacher.do'" ><span class="glyphicon glyphicon-plus"></span>添加</button>
      ...
      <tbody>
         <c:forEach var="teacher" items="${teacherList}" varStatus="vs">
          <tr>
            ...
            <td >
      			<a  href="inputTeacher.do?teacher.id=${teacher.id}" style="cursor:pointer" >修改</a>&nbsp;            	
      			<a  href="deleteTeacher.do?teacher.id=${teacher.id}" style="cursor:pointer" >删除</a>    	      	
            </td>
          </tr>
      	</c:forEach>
      </tbody>
