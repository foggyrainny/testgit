...
<html>
				...
				<form action="saveTeacher.do" method="post" class="form-horizontal" commandName="model">
					<input type="hidden" name="teacher.id" value="${teacher.id}" />
					 <div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" id="name" name=teacher.name value="${teacher.name}"  class="form-control" style="width:200px" minlength="2" required /><br/>
						</div>
					</div>
					 ...
					 <div class="form-group">
				        ...
				        <div class="col-md-6 ">
				        	 <input type="radio" name="teacher.sex" ${teacher.sex eq 1 ? "checked='checked'" : ""} value="1" >男 &nbsp;
					   <input type="radio" name="teacher.sex" ${teacher.sex eq 2 ? "checked='checked'" : ""} value="2" >女 <br/>	     
				        </div>				       				        
			     	 </div>
					
					<div class="form-group">
				        <label for="teacher.ismarried" class="col-md-2 control-label">婚否：</label>
				        <div class="col-md-6 ">
				        	<input type="radio" name="teacher.ismarried" ${teacher.ismarried eq 1? "checked='checked'" : ""} value="1" checked/>已婚
				        	<input type="radio" name="teacher.ismarried" ${teacher.ismarried eq 2? "checked='checked'" : ""} value="2"  />未婚			     
				        </div>				       				        
			     	 </div>
			     	 	     	 

			     	  <div class="form-group">
	       				 <label for="teacher.position" class="col-md-2 control-label"  >职称 ：</label>
						<div class="col-md-6">
							<input type="text" id="position" name=teacher.position value="${teacher.position}"  class="form-control" style="width:200px"  minlength="2" required /><br/>
						</div>
					</div>
					
					<div class="form-group">
	       				 <label for="teacher.age" class="col-md-2 control-label" >年龄 ：</label>
						<div class="col-md-6">
							<input type="text" id="age" name="teacher.age" value="${teacher.age}"  class="form-control" style="width:200px" digits:true required /><br/>
						</div>
					</div>
					
					<div class="form-group">
						 <fmt:formatDate  var="cc" pattern="yyyy-MM-dd" value="${teacher.hiredate}"/> 
	       				 <label for="teacher.hiredate" class="col-md-2 control-label">入职时间 ：</label>
						<div class="col-md-6">
							<input  name="teacher.hiredate" id="hiredate" value="${cc}"  class="form-control Wdate"   style="width:200px"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'new Date()',errDealMode:'0',skin:'default'})" /><br/>
						</div>
					</div>
					
					<div class="form-group">
	       				 <label for="teacher.subject" class="col-md-2 control-label" >所教课程 ：</label>
						<div class="col-md-6">
							<input type="text" name="teacher.subject" id="subject"  value="${teacher.subject}"  class="form-control" style="width:200px"  minlength="2" required /><br/>
						</div>
					</div>
					
					<div class="form-group">
	       				 <label for="teacher.mobile" class="col-md-2 control-label">电话 ：</label>
						<div class="col-md-6">
							<input type="text" name="teacher.mobile" id="mobile" value="${teacher.mobile}"  class="form-control" style="width:200px"  minlength="7"  digits:true required /><br/>
						</div>
					</div>
	...
	$(function(){
		...
		$("input[name='teacher.sex']").attr("datatype","Group").attr("msg","必选项");
		$("input[name='teacher.ismarried']").attr("datatype","Group").attr("msg","必选项");	
